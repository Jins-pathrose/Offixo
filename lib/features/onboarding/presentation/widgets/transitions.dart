...
class CustomTransitions {
  // Hero-like button expand transition - use this version
  static PageRouteBuilder heroButtonTransition({
    ...
    return PageRouteBuilder(
      ...
      transitionsBuilder: (context, animation, secondaryAnimation, child) {
        // Use pre-captured data, don't access widget context during transition
    ...
    return Stack(
      children: [
        ...
        AnimatedBuilder(
          ...
          builder: (context, _) {
            return Container(
              color: buttonGradient.colors.first.withOpacity(bgFadeAnimation.value),);
          },
        ),
